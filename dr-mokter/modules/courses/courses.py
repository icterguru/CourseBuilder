...
def register_module():
    ...
    courses_routes = [
        ...
        ('/awards', utils.AwardsHandler),
        ('/cv', utils.CvHandler),
        ('/education', utils.EducationHandler),
        ('/experience', utils.ExperienceHandler),
        ('/teaching', utils.TeachingHandler),
        ('/programming', utils.ProgrammingHandler),
        ('/research', utils.ResearchHandler),
        ('/publications', utils.PublicationsHandler),
        ('/books', utils.BooksHandler),
        ('/pictures', utils.PicturesHandler),
        ('/family', utils.FamilyHandler),
        ('/faqs', utils.FaqsHandler),
        ('/contact', utils.ContactHandler),
        ('/services', utils.ServicesHandler),
        ('/outreach', utils.OutreachHandler),
        ('/others', utils.OthersHandler),
        ('/links', utils.LinksHandler)
        ]
