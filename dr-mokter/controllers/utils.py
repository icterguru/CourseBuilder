...
class HomeHandler(BaseHandler):
       ...
       def get(self):
           ...
           self.template_value['navbar'] = {'home': True}
           self.render('home.html')

class AwardsHandler(BaseHandler):
       """Handler for Awards page."""
       def get(self):
           """Handles GET requests."""
           
           self.template_value['navbar'] = {'awards': True}
           self.render('awards.html')
...
class CvHandler(BaseHandler):
       ...
       def get(self):
           ...
           self.template_value['navbar'] = {'cv': True}
           self.render('cv.html')


class EducationHandler(BaseHandler):
       """Handler for Education page."""
       def get(self):
           """Handles GET requests."""
           
           self.template_value['navbar'] = {'education': True}
           self.render('education.html')

class ExperienceHandler(BaseHandler):
       """Handler for Experience page."""
       def get(self):
           """Handles GET requests."""
           
           self.template_value['navbar'] = {'experience': True}
           self.render('experience.html')


class TeachingHandler(BaseHandler):
       """Handler for Teaching page."""
       def get(self):
           """Handles GET requests."""
           
           self.template_value['navbar'] = {'teaching': True}
           self.render('teaching.html')

class ProgrammingHandler(BaseHandler):
       """Handler for Programming page."""
       def get(self):
           """Handles GET requests."""
           
           self.template_value['navbar'] = {'programming': True}
           self.render('programming.html')

class ResearchHandler(BaseHandler):
       """Handler for Research page."""
       def get(self):
           """Handles GET requests."""
           
           self.template_value['navbar'] = {'research': True}
           self.render('research.html')


class PublicationsHandler(BaseHandler):
       """Handler for Publications page."""
       def get(self):
           """Handles GET requests."""
           
           self.template_value['navbar'] = {'publications': True}
...
class BooksHandler(BaseHandler):
       ...
       def get(self):
           ...
           self.template_value['navbar'] = {'books': True}
           self.render('books.html')


class PicturesHandler(BaseHandler):
       """Handler for Pictures page."""
       def get(self):
           """Handles GET requests."""
           
           self.template_value['navbar'] = {'pictures': True}
           self.render('pictures.html')


class FamilyHandler(BaseHandler):
       """Handler for Family page."""
       def get(self):
           """Handles GET requests."""
           
           self.template_value['navbar'] = {'family': True}
           self.render('family.html')

class FaqsHandler(BaseHandler):
       """Handler for FAQs page."""
       def get(self):
           """Handles GET requests."""
           
           self.template_value['navbar'] = {'faqs': True}
...
class ContactHandler(BaseHandler):
       ...
       def get(self):
           ...
           self.template_value['navbar'] = {'contact': True}
...
class ServicesHandler(BaseHandler):
       ...
       def get(self):
           ...
           self.template_value['navbar'] = {'services': True}
           self.render('services.html')
 
		   
class OutreachHandler(BaseHandler):
       """Handler for Outreach page."""
       def get(self):
           """Handles GET requests."""
           
           self.template_value['navbar'] = {'outreach': True}
           self.render('outreach.html')


class OthersHandler(BaseHandler):
       """Handler for Others page."""
       def get(self):
           """Handles GET requests."""
           
           self.template_value['navbar'] = {'others': True}
...
class LinksHandler(BaseHandler):
       ...
       def get(self):
           ...
           self.template_value['navbar'] = {'links': True}
