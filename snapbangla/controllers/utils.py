...
class DebugHandler(BaseHandler):
       """Handler for Debug page."""
       def get(self):
           """Handles GET requests."""
           
           self.template_value['navbar'] = {'debug': True}
...
class DiscussionBoardHandler(BaseHandler):
       """Handler for DiscussionBoard page."""
       def get(self):
           """Handles GET requests."""
           
           self.template_value['navbar'] = {'discussionboard': True}
           self.render('discussionboard.html')
